...
public class TileMovement : MonoBehaviour
{
  ...
  private Vector3 GetCorrectPosition()
   {
    // Dùng đúng tileSize mà BoardGen đã dùng để đặt tile ban đầu
    return new Vector3(
        tile.xIndex * MiniTile.tileSize,
        tile.yIndex * MiniTile.tileSize,
        0f
    );
   }
    ...
    private void OnMouseDown()
  {
    ...
    mOffset = transform.position - Camera.main.ScreenToWorldPoint(
      ...
      MiniTile.tilesSorting.BringToTop(mSpriteRenderer);
  }
